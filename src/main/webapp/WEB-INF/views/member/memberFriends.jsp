...
$(function(){
	...
	$(".go").click(function(){
			...
			location.href="memberFriends?curPage="+curPage+"&id="+id;
		}); 
});
</script>
</head>
...
<a href="/fin/member/memberAttend" style="font-weight: normal;">
	...
	<a href="/fin/member/memberPoint" style="font-weight: normal;">
		...
		<div style="width: 1050px; height: 600px;  display: inline-block; float: right;">
		
		 <form action="../friend/friendDel">
	...
	line-height: 100%;">
		<td style="vertical-align: middle; width: 150px; ">NUM</td>
		<td style="vertical-align: middle; ">FRIENDS</td>
		<td style="vertical-align: middle; width: 150px;">DELETE</td>
		</tr>
	...
	<c:forEach items="${list}" var="f">
		...
		<input type="checkbox" name="f_id"  value="${f.f_id }">
		</td>
			</tr>
		</c:forEach>
	...
	<c:if test="${list == '[]'}">
		<tr>
		<td colspan="3" style="text-align: center;">추가한 친구가 없습니다.</td>
		</tr>
	</c:if>
		 
		<tr><td></td><td></td><td></td></tr>
	</table>
	<button class="fDelete">친구삭제</button>
	</form>
