...
<a href="/fin/member/memberAttend" style="font-weight: normal;">
	...
	<a href="/fin/member/memberPoint" style="font-weight: normal;">
		...
		<span style="font-size: 3em; font-weight: bolder; font-family: Georgia;">CHECK ATTENDANCE</span><br> <br> 
		
		<div style="outline: 1px solid #d9d9d9; margin-bottom: 50px;">
		<div style="padding: 30px; line-height: 140%; ">
		<span style="color: #990000; font-size: 0.9em;">[출석체크] 버튼을 눌러 스마일 도장을 모아보세요.</span> <br><br><br> 
		<span style="font-size: 0.9em;">
		· 출석체크는 하루에 한 번 하실 수 있습니다. <br>
		· 출석체크 시 매일 <span style="font-weight: bold;">10포인트</span>가 지급되며 
		7일, 14일, 21일에는 <span style="font-weight: bold;">50포인트</span>가 지급됩니다. <br>
		· 21개의 도장을 모두 모으면 다음날부터 새로 도장을 모을 수 있습니다.  
		</span> 
		</div>
		</div>
		...
		<div style="width: 150px; margin: 40px auto; background-color: #f2ad9f; text-align: center;
		border-radius: 4px;">
		<a style="font-weight: bold; font-size: 1em; font-family: Georgia; color: white;"
		href="/fin/member/attendCheck?id=${member.id}">출석체크</a>
		</div>
			</div>
